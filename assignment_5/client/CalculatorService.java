 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://exercise_5_2/", wsdlLocation = "http://localhost:1234/calc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://exercise_5_2/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1234/calc?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://exercise_5_2/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://exercise_5_2/", "CalculatorPort"), Calculator.class, features);
    }
